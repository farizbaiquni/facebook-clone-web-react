    ...
    return (
        <div className=''>
            ...
            <div className=' overflow-x-hidden overflow-y-auto h-19rem flex flex-col my-3'>
                ...
                <div className={`flex items-center group py-3 cursor-pointer mt-3 mr-2 rounded pr-2 ${(props.accessType === accessTypeOption.public) && 'bg-blue-50'}`} onClick={() => { 
                    accessPublicRef.current?.click(); 
                    props.setAccessType(accessTypeOption.public); 
                    setTimeout( function(){  
                        props.setModalShowSpecific(modalShowOption.main);
                        props.setAccessAllowed(props.idFriends)
                    }, 200)
                }}>
                ...
                <div className={`flex items-center group py-3 cursor-pointer mr-2 rounded pr-2 ${(props.accessType === accessTypeOption.friends) && 'bg-blue-50'}` } onClick={() => { 
                ...
                <div className={`flex items-center group py-3 cursor-pointer mr-2 rounded pr-2 ${(props.accessType === accessTypeOption.except) && 'bg-blue-50'} `} onClick={() => { props.setModalShowSpecific(modalShowOption.except) }}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 p-3 rounded-full group-hover:bg-gray-300 mr-3" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className={`flex items-center group py-3 cursor-pointer mr-2 rounded pr-2 ${(props.accessType === accessTypeOption.specific) && 'bg-blue-50'}`} onClick={() => { props.setModalShowSpecific(modalShowOption.specific) }}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 p-3 rounded-full group-hover:bg-gray-300 mr-3" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className={`flex items-center group py-3 cursor-pointer mr-2 rounded pr-2 ${(props.accessType === accessTypeOption.onlyMe) && 'bg-blue-50'}`} onClick={ () => { 
