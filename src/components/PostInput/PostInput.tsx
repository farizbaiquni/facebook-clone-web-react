...
import { collection, doc, getDoc, getDocs, getFirestore, limit, orderBy, query, startAfter, Timestamp, writeBatch } from 'firebase/firestore';
import React, { createRef, lazy, Suspense, useContext, useState } from 'react'
...
export default function PostInput() {
    ...
    const [lastVisibleUser, setLastVisibleUser] = useState<Object | null>(null)
    ...
    const firstFetchFriends = async() => {
        ...
        const first = query(collection(db, "cities"), orderBy("population"), limit(5));
    ...
    return (
        <div className="post-input mt-10 mb-7 shadow shadow-gray-400">
            ...
            <Modal
                ...
                ariaHideApp={false}
            >    
                <form action="form-sign-up">
                    
                    {modalShowSpecific === 'news'? <p>data</p>: null }
                            ...
                            return (
                                <div className=' overflow-x-hidden overflow-y-auto h-96'>
                                    ...
                                    <div className=' flex flex-col mr-3'>
                                        <div className=" flex items-center group py-2 cursor-pointer mt-5" onClick={() => { 
                                        ...
                                        <div className=" flex items-center group py-2 cursor-pointer" onClick={() => { 
                                        ...
                                        <div className=" flex items-center group py-2 cursor-pointer" onClick={() => { setModalShowSpecific(modalShowOption.except) }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 p-3 rounded-full group-hover:bg-gray-300 mr-3" viewBox="0 0 20 20" fill="currentColor">
                                                <path d="M11 6a3 3 0 11-6 0 3 3 0 016 0zM14 17a6 6 0 00-12 0h12zM13 8a1 1 0 100 2h4a1 1 0 100-2h-4z" />
                                            </svg>
                                            <span className="flex flex-col flex-1">
                                                <p className=' text-lg font-semibold'>Friends except...</p>
                                        ...
                                        <div className=" flex items-center group py-2 cursor-pointer">
                                            ...
                                            <span className="flex flex-col flex-1">
                                                <p className=' text-lg font-semibold'>Specific friends</p>
                                        ...
                                        <div className=" flex items-center group py-2 cursor-pointer" onClick={ () => { 
                                            ...
                                            <span className="flex flex-col flex-1">
                                                <p className=' text-lg font-semibold'>Only me</p>
                                            </span>
