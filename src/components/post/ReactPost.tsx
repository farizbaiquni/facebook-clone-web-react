...
export default function ReactPost(props: propsType) {
  ...
  const determineDisplayedReactIcons = () => {
    ...
    } catch (error) { setDisplayedReactIcons(null)}
  ...
  return (
    <div className=' flex items-center my-3'>
      ...
      {
        (displayedReactIcons !== null) && Array.from(displayedReactIcons).map( key => { 
          switch (key){
              ...
              // case reactTypeOption.haha:
              // return (
                
              // )
              
              // case reactTypeOption.wow:
              // return (
                
              // )

              // case reactTypeOption.sad:
              // return (
                
              // )

              // case reactTypeOption.angry:
              // return (
        ...
        <p className=' flex items-center'>
          ...
          {
            (() => {
              if( props.totalReact <= 0 && props.reactStatus !== null) {
          ...
          {
            (props.totalReact <= 0 && props.reactStatus !== null) && (
